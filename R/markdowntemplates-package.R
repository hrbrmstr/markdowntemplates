...
#'
#' `bulma` (`output: markdowntemplates::bulma`) uses the [Bulma CSS
#' framework](http://bulma.io) and has optional `navtitle` and `navlink` YAML
#' header elements which will be used in header of the generated file.
#'
#' `skeleton` (`output: markdowntemplates::skeleton`) or `default` (`output:
#' markdowntemplates::default`) uses the [Skeleton CSS
#' framework](http://getskeleton.com) and also has optional `navtitle` and
#' `navlink` YAML header elements which will be used in header of the generated
#' file.
#'
#' `minimal` (`output: markdowntemplates::minimal`) uses no CSS framework and
