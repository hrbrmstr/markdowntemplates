...
#' }
#' @export
hrbrmrkdn <- function(number_sections = FALSE,
                      fig_width = 7,
                      fig_height = 5,
  ...
  dep <- htmltools::htmlDependency(
    "hrbrmrkdn", "1.0.0",
    system.file("rmarkdown", "templates", "hrbrmrkdn", "resources", package = "markdowntemplates"),
    stylesheet = c("hrbrmrkdn.css", "prism/prism.css", "bootstrap/bootstrap-theme.min.css"),
  ...
  args <- c(
    ...
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "hrbrmrkdn", "default.html", package = "markdowntemplates")
    )
  )
  ...
  output_format(
    ...
    pandoc = rmarkdown::pandoc_options(
      to = "html", from = from_rmarkdown(fig_caption, md_extensions), args = args
    ),
    keep_md = keep_md,
