#' Restructured text + Skeleton
#'
#' Template for creating an R restructured text (RST) document in Skeleton style
#'
#' More info on \href{http://docutils.sourceforge.net/docs/ref/rst/introduction.html}{RST}.
#'
...
#' date: "`r Sys.Date()`"
#' output: markdowntemplates::rst_skeleton
#' ---}
#'
...
#' }
#' @export
rst_skeleton <- function(number_sections = FALSE,
                         fig_width = 7,
                         fig_height = 5,
